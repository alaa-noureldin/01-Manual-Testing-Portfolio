...
All artifacts here are **fictional**, based on **public/demo applications**, or heavily generalized — **no real client data or sensitive information** is included (NDA respected).
